...
" ==============================================================================
" Migrated from ~/.vimrc. Plain vim keeps its own config; this file is nvim's.
...
" --- Paste ---
" Nothing to configure: nvim handles bracketed paste natively, and
" 'pastetoggle' was removed (E519), so the <F2> fallback is gone with it.
...
" --- Backups & Undo ---
" Kept out of ~/.vim so nvim and vim never write undo/swap files for the same
" source file in the same place.
set undofile                " Persistent undo
set undodir=~/.local/state/nvim/undodir
set backupdir=~/.local/state/nvim/tmp//
set directory=~/.local/state/nvim/tmp//
...
" --- Commenting ---
" No vim-commentary here: nvim ships gc/gcc as built-in default mappings.
